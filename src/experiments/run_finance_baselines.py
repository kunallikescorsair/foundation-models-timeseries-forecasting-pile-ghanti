"""
Run ARIMA and Prophet baselines on the selected finance datasets.
"""
...
def run_finance_baselines(
    ...
    """
    Run ARIMA and Prophet baselines on selected finance datasets.
    ...
    for dataset_key in FINANCE_DATASETS:
        print(f"\nProcessing finance dataset: {dataset_key}")
...
if __name__ == "__main__":
    all_results_df, summary_df, run_status_df = run_finance_baselines(series_limit=10)
